...
bool WorldServer::gmCmd(player_base* estecliente, char Comando[]) {
    char* cmdo;
    char Comando2[255];
    ...
    if (cmdo == NULL) {
        if (strcmp(estecliente->lang, "pt_BR") == 0) {
            SendMessage(estecliente, "Comando inv�lido");
        ...
        if ((cmdo = strtok(NULL, " ,.")) == NULL) {
            if (strcmp(estecliente->lang, "pt_BR") == 0) {
                SendMessage(estecliente, "A sintaxe correta � /lvl n�mero");
            } else if (strcmp(estecliente->lang, "en_US") == 0) {
        ...
        if ((cmdo = strtok(NULL, " ,.")) == NULL) {
            if (strcmp(estecliente->lang, "pt_BR") == 0) {
                SendMessage(estecliente, "A sintaxe correta � /exp n�mero");
            } else if (strcmp(estecliente->lang, "en_US") == 0) {
        ...
        if ((cmdo = strtok(NULL, " ,.")) == NULL) {
            if (strcmp(estecliente->lang, "pt_BR") == 0) {
                SendMessage(estecliente, "A sintaxe correta � /gold n�mero");
            } else if (strcmp(estecliente->lang, "en_US") == 0) {
        ...
        if ((cmdo = strtok(NULL, " ,.")) == NULL) {
            if (strcmp(estecliente->lang, "pt_BR") == 0) {
                SendMessage(estecliente, "A sintaxe correta � /item item_id item_quantidade");
            } else if (strcmp(estecliente->lang, "en_US") == 0) {
        ...
        if ((cmdo = strtok(NULL, " ,.")) == NULL) {
            if (strcmp(estecliente->lang, "pt_BR") == 0) {
                SendMessage(estecliente, "A sintaxe correta � /ban player_nome");
            } else if (strcmp(estecliente->lang, "en_US") == 0) {
        ...
        if ((cmdo = strtok(NULL, " ,.")) == NULL) {
            if (strcmp(estecliente->lang, "pt_BR") == 0) {
                SendMessage(estecliente, "A sintaxe correta � /unban player_nome");
            } else if (strcmp(estecliente->lang, "en_US") == 0) {
        ...
        if ((cmdo = strtok(NULL, " ,.")) == NULL) {
            if (strcmp(estecliente->lang, "pt_BR") == 0) {
                SendMessage(estecliente, "A sintaxe correta � /kick player_nome");
            } else if (strcmp(estecliente->lang, "en_US") == 0) {
        ...
        if ((cmdo = strtok(NULL, " ,.")) == NULL) {
            if (strcmp(estecliente->lang, "pt_BR") == 0) {
                SendMessage(estecliente, "A sintaxe correta � /warn player_nome n�mero");
            } else if (strcmp(estecliente->lang, "en_US") == 0) {
        ...
        if ((cmdo = strtok(NULL, " ,.")) == NULL) {
            if (strcmp(estecliente->lang, "pt_BR") == 0) {
                SendMessage(estecliente, "A sintaxe correta � /go mapa_id");
            } else if (strcmp(estecliente->lang, "en_US") == 0) {
        ...
        if ((cmdo = strtok(NULL, " ,.")) == NULL) {
            if (strcmp(estecliente->lang, "pt_BR") == 0) {
                SendMessage(estecliente, "A sintaxe correta � /go mapa_id x y");
            } else if (strcmp(estecliente->lang, "en_US") == 0) {
        ...
        if ((cmdo = strtok(NULL, " ,.")) == NULL) {
            if (strcmp(estecliente->lang, "pt_BR") == 0) {
                SendMessage(estecliente, "A sintaxe correta � /tempo nome");
            } else if (strcmp(estecliente->lang, "en_US") == 0) {
        ...
        if ((cmdo = strtok(NULL, " ,.")) == NULL) {
            if (strcmp(estecliente->lang, "pt_BR") == 0) {
                SendMessage(estecliente, "A sintaxe correta � /summon monstro_id");
            } else if (strcmp(estecliente->lang, "en_US") == 0) {
        ...
        if ((cmdo = strtok(NULL, " ,.")) == NULL) {
            if (strcmp(estecliente->lang, "pt_BR") == 0) {
                SendMessage(estecliente, "A sintaxe correta � /call player_nome");
            } else if (strcmp(estecliente->lang, "en_US") == 0) {
        ...
        if ((cmdo = strtok(NULL, " ,.")) == NULL) {
            if (strcmp(estecliente->lang, "pt_BR") == 0) {
                SendMessage(estecliente, "A sintaxe correta � /who player_nome");
            } else if (strcmp(estecliente->lang, "en_US") == 0) {
        ...
        if ((cmdo = strtok(NULL, " ,.")) == NULL) {
            if (strcmp(estecliente->lang, "pt_BR") == 0) {
                SendMessage(estecliente, "A sintaxe correta � /guild_lvl n�mero");
            } else if (strcmp(estecliente->lang, "en_US") == 0) {
        ...
        if ((cmdo = strtok(NULL, " ,.")) == NULL) {
            if (strcmp(estecliente->lang, "pt_BR") == 0) {
                SendMessage(estecliente, "A sintaxe correta � /msg texto");
            } else if (strcmp(estecliente->lang, "en_US") == 0) {
        ...
        if ((cmdo = strtok(NULL, " ,.")) == NULL) {
            if (strcmp(estecliente->lang, "pt_BR") == 0) {
                SendMessage(estecliente, "A sintaxe correta � #lvl player_nome n�mero");
            } else if (strcmp(estecliente->lang, "en_US") == 0) {
        ...
        if ((cmdo = strtok(NULL, " ,.")) == NULL) {
            if (strcmp(estecliente->lang, "pt_BR") == 0) {
                SendMessage(estecliente, "A sintaxe correta � #exp player_nome n�mero");
            } else if (strcmp(estecliente->lang, "en_US") == 0) {
        ...
        if ((cmdo = strtok(NULL, " ,.")) == NULL) {
            if (strcmp(estecliente->lang, "pt_BR") == 0) {
                SendMessage(estecliente, "A sintaxe correta � #gold player_nome n�mero");
            } else if (strcmp(estecliente->lang, "en_US") == 0) {
        ...
        if ((cmdo = strtok(NULL, " ,.")) == NULL) {
            if (strcmp(estecliente->lang, "pt_BR") == 0) {
                SendMessage(estecliente, "A sintaxe correta � #item player_nome item_id");
            } else if (strcmp(estecliente->lang, "en_US") == 0) {
        ...
        if ((cmdo = strtok(NULL, " ,.")) == NULL) {
            if (strcmp(estecliente->lang, "pt_BR") == 0) {
                SendMessage(estecliente, "A sintaxe correta � #go player_nome map_id x y");
            } else if (strcmp(estecliente->lang, "en_US") == 0) {
        ...
        if ((cmdo = strtok(NULL, " ,.")) == NULL) {
            if (strcmp(estecliente->lang, "pt_BR") == 0) {
                SendMessage(estecliente, "A sintaxe correta � #buff player_nome");
            } else if (strcmp(estecliente->lang, "en_US") == 0) {
        ...
        if ((cmdo = strtok(NULL, " ,.")) == NULL) {
            if (strcmp(estecliente->lang, "pt_BR") == 0) {
                SendMessage(estecliente, "A sintaxe correta � #repair player_nome");
            } else if (strcmp(estecliente->lang, "en_US") == 0) {
        ...
        if ((cmdo = strtok(NULL, " ,.")) == NULL) {
            if (strcmp(estecliente->lang, "pt_BR") == 0) {
                SendMessage(estecliente, "A sintaxe correta � #heal player_nome");
            } else if (strcmp(estecliente->lang, "en_US") == 0) {
        ...
        if ((cmdo = strtok(NULL, " ,.")) == NULL) {
            if (strcmp(estecliente->lang, "pt_BR") == 0) {
                SendMessage(estecliente, "A sintaxe correta � #max_stats player_nome");
            } else if (strcmp(estecliente->lang, "en_US") == 0) {
        ...
        if ((cmdo = strtok(NULL, " ,.")) == NULL) {
            if (strcmp(estecliente->lang, "pt_BR") == 0) {
                SendMessage(estecliente, "A sintaxe correta � #max_hab player_nome");
            } else if (strcmp(estecliente->lang, "en_US") == 0) {
        ...
        if ((cmdo = strtok(NULL, " ,.")) == NULL) {
            if (strcmp(estecliente->lang, "pt_BR") == 0) {
                SendMessage(estecliente, "A sintaxe correta � #guild_lvl player_nome n�mero");
            } else if (strcmp(estecliente->lang, "en_US") == 0) {
        ...
        if ((cmdo = strtok(NULL, " ,.")) == NULL) {
            if (strcmp(estecliente->lang, "pt_BR") == 0) {
                SendMessage(estecliente, "A sintaxe correta � #save player_nome");
            } else if (strcmp(estecliente->lang, "en_US") == 0) {
...
bool Server::GM_lvl(player_base* estecliente, int lvl) {
    if (lvl > 0) {
        ...
        if (strcmp(estecliente->lang, "pt_BR") == 0) {
            SendMessage(estecliente, "Voc� subiu %i leveis!", lvl);
        } else if (strcmp(estecliente->lang, "en_US") == 0) {
        ...
        if (strcmp(estecliente->lang, "pt_BR") == 0) {
            SendMessage(estecliente, "Voc� desceu %i leveis!", -lvl);
        } else if (strcmp(estecliente->lang, "en_US") == 0) {
...
bool Server::GM_exp(player_base* estecliente, long int exp) {
    if (exp > 0) {
        ...
        if (strcmp(estecliente->lang, "pt_BR") == 0) {
            SendMessage(estecliente, "Voc� ganhou %i pontos de experi�ncia!", exp);
        } else if (strcmp(estecliente->lang, "en_US") == 0) {
        ...
        if (strcmp(estecliente->lang, "pt_BR") == 0) {
            SendMessage(estecliente, "Voc� perdeu %i pontos de experi�ncia!", -exp);
        } else if (strcmp(estecliente->lang, "en_US") == 0) {
...
bool Server::GM_gold(player_base* estecliente, long int gold) {
    if (gold > 0) {
        ...
        if (strcmp(estecliente->lang, "pt_BR") == 0) {
            SendMessage(estecliente, "Voc� ganhou %i golds!", gold);
        } else if (strcmp(estecliente->lang, "en_US") == 0) {
        ...
        if (strcmp(estecliente->lang, "pt_BR") == 0) {
            SendMessage(estecliente, "Voc� perdeu %i golds!", -gold);
        } else if (strcmp(estecliente->lang, "en_US") == 0) {
    ...
    if (outrocliente != NULL) {
        if (estecliente->perm > outrocliente->perm) {
            ...
            if (strcmp(outrocliente->lang, "pt_BR") == 0) {
                SendMessage(outrocliente, "Voc� foi banido");
        ...
        if (outrocliente != NULL) {
            ...
            if (strcmp(estecliente->lang, "pt_BR") == 0) {
                SendMessage(estecliente, "Este player: %s n�o existe ou n�o est� logado", banid);
            } else if (strcmp(estecliente->lang, "en_US") == 0) {
...
bool Server::GM_unban(player_base* estecliente, char* unbanid) {
    ...
    if (outrocliente != NULL) {
        ...
        if (strcmp(estecliente->lang, "pt_BR") == 0) {
            SendMessage(estecliente, "Este player: %s n�o existe", unbanid);
        } else if (strcmp(estecliente->lang, "en_US") == 0) {
...
bool Server::GM_kick(player_base* estecliente, char* kickid) {
    ...
    if (outrocliente != NULL) {
        if (estecliente->perm > outrocliente->perm) {
            ...
            if (strcmp(outrocliente->lang, "pt_BR") == 0) {
                SendMessage(outrocliente, "Voc� foi kickado");
            } else if (strcmp(outrocliente->lang, "en_US") == 0) {
        ...
        if (strcmp(estecliente->lang, "pt_BR") == 0) {
            SendMessage(estecliente, "Este player: %s n�o existe ou n�o est� logado", kickid);
        } else if (strcmp(estecliente->lang, "en_US") == 0) {
...
bool Server::GM_warn(player_base* estecliente, char* warnid, int warnnum) {
    ...
    if (outrocliente != NULL) {
        if (estecliente->perm > outrocliente->perm) {
            ...
            if (strcmp(outrocliente->lang, "pt_BR") == 0) {
                SendMessage(outrocliente, "Voc� recebeu %i pontos de warn", warnnum);
            } else if (strcmp(outrocliente->lang, "en_US") == 0) {
        ...
        if (strcmp(estecliente->lang, "pt_BR") == 0) {
            SendMessage(estecliente, "Este player: %s n�o existe ou n�o est� logado", warnid);
        } else if (strcmp(estecliente->lang, "en_US") == 0) {
...
bool Server::GM_go(player_base* estecliente, unsigned int goid, float gox, float goy) {
    ...
    if (strcmp(estecliente->lang, "pt_BR") == 0) {
        SendMessage(estecliente, "Voc� foi teleportado para o mapa:%i X:%i Y:%i", goid, gox, goy);
    } else if (strcmp(estecliente->lang, "en_US") == 0) {
...
bool Server::GM_call(player_base* estecliente, char* callid) {
    ...
    if (outrocliente != NULL) {
        if (estecliente->perm > outrocliente->perm) {
            ...
            if (strcmp(estecliente->lang, "pt_BR") == 0) {
                SendMessage(estecliente, "O player %i:%s foi teleportado at� voc�", outrocliente->id, outrocliente->usuario);
            } else if (strcmp(estecliente->lang, "en_US") == 0) {
                SendMessage(estecliente, "The player %i:%s has been teleported to you", outrocliente->id, outrocliente->usuario);
            }
            if (strcmp(outrocliente->lang, "pt_BR") == 0) {
                SendMessage(outrocliente, "Voc� foi teleportado at� %s", estecliente->chars[estecliente->chara].nome);
            } else if (strcmp(outrocliente->lang, "en_US") == 0) {
        ...
        if (strcmp(estecliente->lang, "pt_BR") == 0) {
            SendMessage(estecliente, "Este player: %s n�o existe ou n�o est� logado", callid);
        } else if (strcmp(estecliente->lang, "en_US") == 0) {
...
bool Server::GM_hide(player_base* estecliente) {
    if (estecliente->hide == 0) {
        estecliente->hide = 1;
        if (strcmp(estecliente->lang, "pt_BR") == 0) {
            SendMessage(estecliente, "Voc� agora n�o est� vis�vel para outros players");
        } else if (strcmp(estecliente->lang, "en_US") == 0) {
        ...
        estecliente->hide = 0;
        if (strcmp(estecliente->lang, "pt_BR") == 0) {
            SendMessage(estecliente, "Voc� agora est� vis�vel para outros players");
        } else if (strcmp(estecliente->lang, "en_US") == 0) {
...
bool Server::GM_maxstat(player_base* estecliente) {
    ...
    if (strcmp(estecliente->lang, "pt_BR") == 0) {
        SendMessage(estecliente, "Todos os seus status foram setados para o m�ximo");
    } else if (strcmp(estecliente->lang, "en_US") == 0) {
...
bool Server::GM_guildlvl(player_base* estecliente, int lvl) {
    ...
    if (guild != NULL) {
        ...
        if (strcmp(estecliente->lang, "pt_BR") == 0) {
            SendMessage(estecliente, "Voc� n�o pertence a nenhuma guild!");
        } else if (strcmp(estecliente->lang, "en_US") == 0) {
...
bool Server::GM_save(player_base* estecliente) {
    ...
    if (strcmp(estecliente->lang, "pt_BR") == 0) {
        SendMessage(estecliente, "Sua posi��o atual foi salva como seu ponto de respawn padr�o");
    } else if (strcmp(estecliente->lang, "en_US") == 0) {
...
bool Server::GM_A_lvl(player_base* estecliente, char* player, int lvl) {
    ...
    if (outrocliente != NULL) {
        if (estecliente->perm > outrocliente->perm) {
            ...
            if (strcmp(estecliente->lang, "pt_BR") == 0) {
                SendMessage(estecliente, "Voc� concedeu %i leveis para o player %i:%s Char:%i:%s", lvl, outrocliente->id, outrocliente->usuario, outrocliente->chars[outrocliente->chara].id, outrocliente->chars[outrocliente->chara].nome);
            } else if (strcmp(estecliente->lang, "en_US") == 0) {
            ...
            if (strcmp(outrocliente->lang, "pt_BR") == 0) {
                SendMessage(outrocliente, "Voc� recebeu %i leveis do player: %s", lvl, estecliente->chars[estecliente->chara].nome);
            } else if (strcmp(outrocliente->lang, "en_US") == 0) {
        ...
        if (strcmp(estecliente->lang, "pt_BR") == 0) {
            SendMessage(estecliente, "Este player: %s n�o existe ou n�o est� logado", player);
        } else if (strcmp(estecliente->lang, "en_US") == 0) {
...
bool Server::GM_A_exp(player_base* estecliente, char* player, long int exp) {
    ...
    if (outrocliente != NULL) {
        if (estecliente->perm > outrocliente->perm) {
            ...
            if (strcmp(estecliente->lang, "pt_BR") == 0) {
                SendMessage(estecliente, "Voc� concedeu %i pontos de experi�ncia para o player %i:%s Char:%i:%s", exp, outrocliente->id, outrocliente->usuario, outrocliente->chars[outrocliente->chara].id, outrocliente->chars[outrocliente->chara].nome);
            } else if (strcmp(estecliente->lang, "en_US") == 0) {
            ...
            if (strcmp(outrocliente->lang, "pt_BR") == 0) {
                SendMessage(outrocliente, "Voc� recebeu %i pontos de experi�ncia do player: %s", exp, estecliente->chars[estecliente->chara].nome);
            } else if (strcmp(outrocliente->lang, "en_US") == 0) {
...
bool Server::GM_A_gold(player_base* estecliente, char* player, long int gold) {
    ...
    if (outrocliente != NULL) {
        if (estecliente->perm > outrocliente->perm) {
            ...
            if (strcmp(estecliente->lang, "pt_BR") == 0) {
                SendMessage(estecliente, "Voc� concedeu %i golds para o player %i:%s Char:%i:%s", gold, outrocliente->id, outrocliente->usuario, outrocliente->chars[outrocliente->chara].id, outrocliente->chars[outrocliente->chara].nome);
            } else if (strcmp(estecliente->lang, "en_US") == 0) {
            ...
            if (strcmp(outrocliente->lang, "pt_BR") == 0) {
                SendMessage(outrocliente, "Voc� recebeu %i golds do player: %s", gold, estecliente->chars[estecliente->chara].nome);
            } else if (strcmp(outrocliente->lang, "en_US") == 0) {
...
bool Server::GM_A_go(player_base* estecliente, char* player, unsigned int goid, float gox, float goy) {
    ...
    if (outrocliente != NULL) {
        if (estecliente->perm > outrocliente->perm) {
            ...
            if (strcmp(estecliente->lang, "pt_BR") == 0) {
                SendMessage(estecliente, "Voc� teleportou o player %i:%s Char:%i:%s para mapa:%i X:%i Y:%i", outrocliente->id, outrocliente->usuario, outrocliente->chars[outrocliente->chara].id, outrocliente->chars[outrocliente->chara].nome, goid, gox, goy);
            } else if (strcmp(estecliente->lang, "en_US") == 0) {
            ...
            if (strcmp(outrocliente->lang, "pt_BR") == 0) {
                SendMessage(outrocliente, "Voc� foi teleportado at� o player: %s", estecliente->chars[estecliente->chara].nome);
            } else if (strcmp(outrocliente->lang, "en_US") == 0) {
...
bool Server::GM_A_heal(player_base* estecliente, char* player) {
    ...
    if (outrocliente != NULL) {
        if (estecliente->perm > outrocliente->perm) {
            ...
            if (strcmp(estecliente->lang, "pt_BR") == 0) {
                SendMessage(estecliente, "Voc� restaurou o hp e o mp do player %i:%s Char:%i:%s", outrocliente->id, outrocliente->usuario, outrocliente->chars[outrocliente->chara].id, outrocliente->chars[outrocliente->chara].nome);
            } else if (strcmp(estecliente->lang, "en_US") == 0) {
...
bool Server::GM_A_maxstat(player_base* estecliente, char* player) {
    ...
    if (outrocliente != NULL) {
        if (estecliente->perm > outrocliente->perm) {
            ...
            if (strcmp(estecliente->lang, "pt_BR") == 0) {
                SendMessage(estecliente, "Voc� setou todos os status do player %i:%s Char:%i:%s para o m�ximo", outrocliente->id, outrocliente->usuario, outrocliente->chars[outrocliente->chara].id, outrocliente->chars[outrocliente->chara].nome);
            } else if (strcmp(estecliente->lang, "en_US") == 0) {
            ...
            if (strcmp(outrocliente->lang, "pt_BR") == 0) {
                SendMessage(outrocliente, "Todos seus status foram setatos para o m�ximo pelo player: %s", estecliente->chars[estecliente->chara].nome);
            } else if (strcmp(outrocliente->lang, "en_US") == 0) {
    ...
    if (outrocliente != NULL) {
        if (estecliente->perm > outrocliente->perm) {
            ...
            if (guild != NULL) {
                guild->lvl += lvl;
                if (strcmp(estecliente->lang, "pt_BR") == 0) {
                    SendMessage(estecliente, "Voc� concedeu %i leveis para a guild %i:%s do player %i:%s Char:%i:%s", lvl, guild->id, guild->nome, outrocliente->id, outrocliente->usuario, outrocliente->chars[outrocliente->chara].id, outrocliente->chars[outrocliente->chara].nome);
                } else if (strcmp(estecliente->lang, "en_US") == 0) {
                ...
                if (strcmp(estecliente->lang, "pt_BR") == 0) {
                    SendMessage(estecliente, "Este player: %i:%s Char:%i:%s n�o possui uma guild", outrocliente->id, outrocliente->usuario, outrocliente->chars[outrocliente->chara].id, outrocliente->chars[outrocliente->chara].nome);
                } else if (strcmp(estecliente->lang, "en_US") == 0) {
...
bool Server::GM_A_save(player_base* estecliente, char* player) {
    ...
    if (outrocliente != NULL) {
        if (estecliente->perm > outrocliente->perm) {
            ...
            if (strcmp(outrocliente->lang, "pt_BR") == 0) {
                SendMessage(outrocliente, "Seu ponto de respaw padr�o foi alterado para sua posi��o atual pelo player: %s", estecliente->chars[estecliente->chara].nome);
            } else if (strcmp(outrocliente->lang, "en_US") == 0) {
